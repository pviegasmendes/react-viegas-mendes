    ...
    return (
        <>
            <div className="w-80 border-solid  rounded-2xl mt-7 mb-9 shadow-xl overflow-hidden">
                ...
                <div className="p-4">
                    <button className="flex justify-center font-bold w-full p-4 mb-2 border-solid border-2 border-violet-500 bg-white rounded-xl hover:bg-violet-500 hover:text-white">
                        Product Details
                    </button>
